...
class Notifications(db.Model):
    ...
    @property
    def html(self):
        from CTFdpp.utils.config.pages import build_markdown
        from CTFdpp.utils.helpers import markup
...
class Pages(db.Model):
    ...
    @property
    def html(self):
        from CTFdpp.utils.config.pages import build_html, build_markdown
...
class Challenges(db.Model):
    ...
    def plugin_class(self):
        from CTFdpp.challenges import get_chal_class
...
class Users(db.Model):
    ...
    def validate_password(self, key, plaintext):
        from CTFdpp.utils.crypto import hash_password
    ...
    def get_place(self, admin=False, numeric=False):
        """
        This method is generally a clone of CTFdpp.scoreboard.get_standings.
        ...
        from CTFdpp.utils.scores import get_user_standings
...
class Teams(db.Model):
    ...
    def get_invite_code(self):
        ...
        from CTFdpp.utils.security.signing import hmac, serialize
    ...
    def get_place(self, admin=False, numeric=False):
        ...
        """
        from CTFdpp.utils.humanize.numbers import ordinalize
        from CTFdpp.utils.scores import get_team_standings  # noqa: I001
