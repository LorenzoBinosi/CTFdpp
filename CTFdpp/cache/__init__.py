...
def clear_config():
    from CTFdpp.utils import _get_config, get_app_config
...
def clear_standings():
    ...
    from CTFdpp.api.v1.scoreboard import ScoreboardDetail, ScoreboardList
    from CTFdpp.constants.static import CacheKeys
    from CTFdpp.models import Teams, Users  # noqa: I001
    from CTFdpp.utils.scoreboard import get_scoreboard_detail
    from CTFdpp.utils.scores import get_standings, get_team_standings, get_user_standings
...
def clear_challenges():
    from CTFdpp.utils.challenges import get_all_challenges  # noqa: I001
...
def clear_ratings():
    from CTFdpp.utils.challenges import get_rating_average_for_challenge_id

    cache.delete_memoized(get_rating_average_for_challenge_id)


def clear_pages():
    from CTFdpp.utils.config.pages import get_page, get_pages
...
def clear_user_recent_ips(user_id):
    from CTFdpp.utils.user import get_user_recent_ips

    cache.delete_memoized(get_user_recent_ips, user_id=user_id)


def clear_user_session(user_id):
    from CTFdpp.utils.user import (  # noqa: I001
        get_user_attrs,
        get_user_place,
        get_user_recent_ips,
        get_user_schema,
