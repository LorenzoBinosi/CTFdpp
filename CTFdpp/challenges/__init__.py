from CTFdpp.challenges.base import (
    CHALLENGE_CLASSES,
    BaseChallenge,
    ChallengeResponse,
    calculate_value,
...
# NOTE: the user-facing blueprint lives in CTFdpp.challenges.views and is imported
...
from CTFdpp.challenges import dynamic, standard  # noqa: F401,E402
