...
import CTFdpp.utils.config
from CTFdpp import utils
from CTFdpp.constants.themes import ADMIN_THEME, DEFAULT_THEME
from CTFdpp.utils.crypto import sha256
from CTFdpp.utils.initialization import (
    init_cli,
    init_events,
    init_logs,
...
from CTFdpp.utils.migrations import create_database, migrations, stamp_latest_revision
from CTFdpp.utils.sessions import CachingSessionInterface
...
class CTFdppFlask(Flask):
    ...
    def create_jinja_environment(self):
        ...
        return super(CTFdppFlask, self).create_jinja_environment()
    ...
    def create_url_adapter(self, request):
        ...
        return super(CTFdppFlask, self).create_url_adapter(request)
...
def create_app(config="CTFdpp.config.Config"):
    app = CTFdppFlask(__name__)
    with app.app_context():
        app.config.from_object(config)

        from CTFdpp.cache import cache
        from CTFdpp.utils import import_in_progress
        ...
        for theme_name in CTFdpp.utils.config.get_themes():
        ...
        # expose the CTFdpp.challenges and CTFdpp.flags package directories to Jinja.
        loaders.append(
            jinja2.PrefixLoader(
                {
        ...
        from CTFdpp.models import (  # noqa: F401
            Challenges,
            Fails,
            Files,
            Flags,
        ...
        import CTFdpp.challenges as _challenges  # noqa: F401
        import CTFdpp.flags as _flags  # noqa: F401
        ...
        from CTFdpp.api import api
        from CTFdpp.auth import auth
        from CTFdpp.challenges.views import challenges
        from CTFdpp.errors import render_error
        from CTFdpp.events import events
        from CTFdpp.flags.views import flags
        from CTFdpp.scoreboard import scoreboard
        from CTFdpp.share import social
        from CTFdpp.teams import teams
        from CTFdpp.users import users
        from CTFdpp.views import views
