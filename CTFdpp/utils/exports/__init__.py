...
from CTFdpp import __version__ as CTFD_VERSION
from CTFdpp.cache import cache
from CTFdpp.constants.themes import DEFAULT_THEME
from CTFdpp.models import db, get_class_by_tablename
from CTFdpp.utils import get_app_config, get_config, set_config, string_types
from CTFdpp.utils.config import get_themes
from CTFdpp.utils.dates import unix_time
from CTFdpp.utils.exports.databases import is_database_mariadb
from CTFdpp.utils.exports.freeze import freeze_export
from CTFdpp.utils.migrations import (
    create_database,
    drop_database,
...
from CTFdpp.utils.uploads import get_uploader
...
def import_ctf(backup, erase=True, ignore_overrides=False):
    ...
    # Check if the alembic version is from CTFdpp 1.x
    ...
    if sqlite is False and alembic_version not in get_available_revisions():
        set_import_error(
            "Exception: The target migration in this backup is not available in this version of CTFdpp."
        )
        raise Exception(
            "The target migration in this backup is not available in this version of CTFdpp."
        )
