...
from CTFdpp.models import Solves, Users
from CTFdpp.utils import get_config
from CTFdpp.utils.config import is_teams_mode
from CTFdpp.utils.formatters import safe_html_format
...
class SolveSocialShare(object):
    ...
    @property
    def content(self):
        from CTFdpp.utils.challenges import get_solve_counts_for_challenges
