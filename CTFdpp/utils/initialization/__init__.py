...
from CTFdpp.cache import clear_user_recent_ips
from CTFdpp.exceptions import UserNotFoundException, UserTokenExpiredException
from CTFdpp.exceptions.email import UserResetPasswordTokenInvalidException
from CTFdpp.models import Tracking, db
from CTFdpp.utils import config, get_app_config, get_config, import_in_progress, markdown
from CTFdpp.utils.config import (
    can_send_mail,
    ctf_logo,
    ctf_name,
    ctf_theme,
...
from CTFdpp.utils.config.pages import get_pages
from CTFdpp.utils.dates import isoformat, unix_time, unix_time_millis, unix_time_to_utc
from CTFdpp.utils.events import EventManager, RedisEventManager
from CTFdpp.utils.humanize.words import pluralize
from CTFdpp.utils.modes import generate_account_url, get_mode_as_word
from CTFdpp.utils.security.auth import login_user, logout_user, lookup_user_token
from CTFdpp.utils.security.csrf import generate_nonce
from CTFdpp.utils.security.email import (
    generate_password_reset_token,
    verify_reset_password_token,
)
from CTFdpp.utils.user import (
    authed,
...
def init_template_globals(app):
    from CTFdpp.constants import JINJA_ENUMS  # noqa: I001
    from CTFdpp.constants.assets import Assets
    from CTFdpp.constants.config import Configs
    from CTFdpp.constants.languages import Languages
    from CTFdpp.constants.plugins import Plugins
    from CTFdpp.constants.sessions import Session
    from CTFdpp.constants.static import Static
    from CTFdpp.constants.teams import Team
    from CTFdpp.constants.users import User
    from CTFdpp.forms import Forms
    from CTFdpp.utils.config.visibility import (
        accounts_visible,
        challenges_visible,
        registration_visible,
        scores_visible,
    )
    from CTFdpp.utils.countries import get_countries, lookup_country_code
    from CTFdpp.utils.countries.geoip import lookup_ip_address, lookup_ip_address_city
